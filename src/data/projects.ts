...
export const projects: Project[] = [
  {
    ...
    teamSize: 1,
    demoUrl: "https://my-fund-request-app-tzo2.vercel.app/",
  ...
  {
    id: 4,
    slug: "My Agro Store Project",
    title: "My Agro Store Project",
    shortDescription: "E-commerce platform for agricultural products.",
    longDescription: "A comprehensive e-commerce platform designed for the agricultural sector, allowing farmers and vendors to sell their products online. Features include product listings, shopping cart functionality, user authentication, and payment integration. Built with modern web technologies to ensure a seamless user experience.",
    technologies: ["React", "Node.js", "MongoDB", "Express", "Stripe"],
    status: "in-progress",
    category: "web-development",
    role: "Frontend Developer",
    teamSize: 1,
    demoUrl: "https://agroworld.onrender.com/",
    githubUrl: "https://github.com/EmmaDeil/MyAgroHub-Project.git",
    image: "/Screenshot 2025-10-29 091400.png",
    featured: false
  },
  {
    id: 9,
  ...
  },
  {
    ...
    shortDescription: "Guest Management System - A modern, cloud-based visitor registration platform that streamlines guest check-ins using QR code technology.",
  ...
  },
  {
    id: 11,
    slug: "Asset-app",
    title: "Assetflow Asset Management App",
    ...
    technologies: ["React", "MongoDB", "Express", "Node.js", "Mongoose", "Tailwind CSS", "HTML5", "JavaScript"],
    status: "in-progress",
    category: "web-development",
    role: "Full-stack Developer",
    teamSize: 0,
    demoUrl: "https://assetflow-3gdr.onrender.com",
